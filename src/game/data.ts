...
const NPC_DIALOGUES: Record<number, string[][]> = {
  ...
  1: [
    [
      ">>> GHOST_SIGNAL <<<",
      "The central labs are segmented; push east to breach deeper sectors.",
      "The lock in mid-core needs a keycard from the quarantine wing.",
      "If you're bleeding, there's a med-kit near the old test benches.",
    ],
    [
      ">>> LAB_TECH // DISTRESS <<<",
      "Two sentinels patrol the key route. Don't fight both at once.",
      "Armor was stashed south of the blast door if you need to tank up.",
      "Stairs are in the far reactor lane. If you hear static, run.",
    ],
  ],
  2: [
    [
